...
static __cold bool double_table(struct htable *ht)
{
	unsigned int i;
...
static __cold void rehash_table(struct htable *ht)
{
	size_t start, i;
	uintptr_t e;
...
static __cold void update_common(struct htable *ht, const void *p)
{
	unsigned int i;
